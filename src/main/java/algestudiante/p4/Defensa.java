...
public class Defensa {
	...
	public int[] asignar() {
		...
		// mientras haya ciudades con enemigos
		for (int i = 0; i < enemigos.length; i++) {

			// funcion de seleccion del mejor candidato
		...
		if (count < grupoDefensaRapida.length) {
	...
	/**
	 * Muestra en consola, los �ndices de las ciudades invadidas, los efectivos
	 * enemigos y los efectivos de defensa asignados y el resultado final en funci�n
	 * de esta asignaci�n: Victoria / Derrota
	 */
	public void mostrarPlanDefensaVertical() {
		...
		for (int i = 0; i < n; i++) {
			...
			// System.out.print((grupoDefensaRapida[asignacion[i]]>=enemigos[i]?"Vict.
			// +":"Derr. �")+"\t");
			System.out.println();
		}
	 ...
	 * 
	 * @return Asignaci�n de defensa a ciudades (�ndice del equipo de defensa
	 *         r�pida)
	 */
